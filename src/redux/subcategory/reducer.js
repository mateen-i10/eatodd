...
const SubCategoryReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case setSubCategory.type:
            ...
            return {
                ...state,
                object:{...data1, category: {label: data1.category?.name, value: data1.categoryId}, isBlank: data1.isBlank},
                isEdit: false,
                isLoading: false,
                isDetailLoading: false
            }
        ...
        case editSubCategory.type:
            ...
            return {
                ...state,
                object: {...data, category: {label: data.category?.name, value: data.categoryId}, isBlank: data.isBlank},
                isEdit: true
            }
