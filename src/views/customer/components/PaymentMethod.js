...
import { Plus, Check, X, SkipBack } from 'react-feather'
        ...
        <Fragment>
            <Card>
                <CardHeader>
                    ...
                    <div>
                        <Button color='primary' size='sm' onClick={() => handleBack()}>
                            <SkipBack className='me-50' size={14} />
                            <span>Go back</span>
                        </Button>
                        <Button color='primary' size='sm' style={{marginLeft:20}} onClick={openAddModal}>
