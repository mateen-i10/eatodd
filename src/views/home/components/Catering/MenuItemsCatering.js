...
const MenuItemsCatering = (props) => {
    ...
    return (
        <div className="card" style={{height: "465px", border: '1px solid #81be41'}}>
            <div>
                <img src={props.img} className="card-img-top" alt="..." />
            </div>
            <div style={{position: 'absolute', marginTop: 170, backgroundColor: '#81be41', height: 30, width:"100%", opacity: "68%"}}>
            </div>
            ...
            <Button color="primary" onClick={() => console.log('clicked')}>Add to Bag</Button>
        </div>
    )
}
