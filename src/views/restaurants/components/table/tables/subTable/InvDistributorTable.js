...
// ** Table Columns
import {distributorColumns} from "../../tableColumns"
// ** data from datatable
...
const InvDistributorTable = () => {

    // // ** States
    const items = getInvDistributorData()
        ...
        <Fragment>
            <Card>
                <CardHeader className='border-bottom'>
                    <CardTitle tag='h4'>Inventory Distributor</CardTitle>
                </CardHeader>
...
export default memo(InvDistributorTable)
