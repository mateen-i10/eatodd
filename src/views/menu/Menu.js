                    ...
                    <ul className="nav justify-content-center" style={{marginTop: 15}}>
                        ...
                        <li className="nav-item" style={{marginLeft: 20}}>
                            <InputGroup>
                                ...
                                <Button.Ripple style={{width: 25, height: 25}} className='btn-icon'
                                               onClick={() => console.log('the zip code')}>
                                ...
                                <div className="banner-3-img" style={{textAlign: 'left', paddingLeft: 135}}>
                                    <div>
                                        <h1 style={{
                                            ...
                                            letterSpacing: -1,
                                            lineHeight: .9,
                                            fontFamily: 'Helvetica, TradeGothic'
                                        }}>BURRITOS</h1>
                                        <h1 style={{
                                            color: '#81be41',
                                            verticalAlign: 'middle',
                                        ...
                                        <h6 style={{color: '#81be41', fontFamily: 'Helvetica,Arial,sans-serif'}}>Minimum
                                            6 people</h6>
                                        <Link to="/EventDetails">
                                            <button type="button" className="col-md-10 btn but" id='condition'
                                                    style={{height: 50, marginBottom: 30, marginTop: 30}}>
                                                START A BURRITO BOX
                                                <ArrowRight style={{marginTop: -3, marginLeft: 6, color: 'white'}}
                                                            size={16}/>
                                            </button>
                                        </Link>
                                        <div style={{color: '#786259', fontSize: 10, fontFamily: 'Helvetica'}}>
                                            <p>Please place your order at least 24 hours in advance, so we can
                                                coordinate making it along with all of the food we prepare fresh every
                                                day.</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <section id="banner-3" className="bg-yellow banner-section division"
                    ...
                    <div className="container-sm">
                        <div className="row d-flex align-items-center">
                            ...
                            <div className="col-md-7 col-lg-6" style={{
                                border: 'solid',
                                borderLeft: 0,
                                borderTop: 0,
                                borderBottom: 0,
                                ...
                                <div id='ControlledExample' style={{textAlign: 'center'}}>
                                    ...
                                    <h6 style={{color: '#81be41', fontFamily: 'Helvetica,Arial,sans-serif'}}>Minimum 10
                                        people</h6>
                                </div>
                            </div>
                            ...
                            <div className="col-md-5 col-lg-6">
                                <div className="banner-3-img" style={{textAlign: 'center'}}>
                                    ...
                                    <button type="button" className="col-md-8 btn but" id='condition'
                                            style={{height: 50, marginBottom: 30, marginTop: 30}}>
                                        START A BURRITO BOX
                                        <ArrowRight style={{marginTop: -3, marginLeft: 6, color: 'white'}} size={16}/>
                                    </button>
                                    <h6 style={{color: '#786259', fontSize: 10}}>Please place your order at least 24
                                        hours in advance, so we can<br/> coordinate making it along with all of the food
                                        we prepare fresh every day.</h6>
                                </div>
                                <Tooltip
                                    placement='top'
                                    isOpen={tooltipOpen}
                ...
                <div className="container-fluid">
                    <div className="row" style={{textAlign: 'center', paddingTop: 120}}>
                        <div className="col-sm">
                            ...
                            <a style={{color: '#57ab00', fontSize: 24, fontWeight: 700}} href="#">SWITCH TO GROUP
                                ORDER</a>
