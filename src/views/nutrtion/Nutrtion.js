            ...
            <div className="container-fluid" style={{backgroundColor:'#e3e3e3'}}>
                    <div className='row'>
                        <div className="col" style={{marginLeft:180, marginTop:60, marginBottom:50}}>
                            ...
                            <p style={{fontWeight:450}}>Build your calorie, carb and nutrition information based on your selected meal below using the nutrition calculator.</p>
...
<<<<<<< HEAD
                        <div className='col rounded-circle' style={{
...
>>>>>>> origin/master
            ...
            <div className='container'>
                <div className='row pb-5 pt-5'>
                    <h3 style={{fontWeight:'bolder', color:'#57ab00', marginLeft:100, marginBottom: 40, textTransform:'uppercase'}}>Select Your Meal</h3>
                    {FoodItems.map((e) => (
                        <div>
...
=======
            <div className='container-fluid bgimg' style={{textAlign:'center', paddingTop: '100px', paddingBottom: '100px'}}>
                <div className='row'>
