                        ...
                        <div className="row g-0">
                            ...
                            <div className="col-8 ">
                                <div className="card-body" style={{
                                    ...
                                    <div className="card-title mb-0 text-start text-uppercase text-primary fw-bolder" style={{ fontSize: '1.2rem' }}>
                                        {product.name}
                                        {product.price !== 0 && (
                                            <h5 className="fw-bolder text-dark me-2 text-lowercase" style={{ marginTop: 15 }}>
                                                ${product.price}
                                            </h5>
                                        )}
                                    </div>
